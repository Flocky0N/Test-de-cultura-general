...
namespace Preguntas_y_respuestas
{
    public partial class Pregunta7 : Form
    {
        ...
        private void btnContinuar_Click(object sender, EventArgs e)
        {
            ...
            Pregunta8 pregunta8 = new Pregunta8();

            // Configurar la posición del siguiente formulario
            pregunta8.StartPosition = FormStartPosition.Manual;       // Usar posición manual
            pregunta8.Location = this.Location;                      // Posicionar en la misma ubicación
